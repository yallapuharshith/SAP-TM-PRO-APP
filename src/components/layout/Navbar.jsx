      ...
      <div className="flex items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <motion.button
            ...
            type="button"
            onClick={onMenuClick}
            className="min-h-11 min-w-11 rounded-xl border border-white/15 bg-white/10 p-2 text-slate-100 lg:hidden"
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            type="button"
            className="hidden min-h-11 min-w-11 rounded-xl border border-white/15 bg-white/10 p-2 text-slate-100 hover:bg-white/15 sm:inline-flex"
            aria-label="Search"
          >
          ...
          <button
            type="button"
            className="min-h-11 min-w-11 rounded-xl border border-white/15 bg-white/10 p-2 text-slate-100 hover:bg-white/15"
